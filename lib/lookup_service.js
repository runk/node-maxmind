...
module.exports.init = function(path, opts) {
    ...
    this.databaseInfo = new DatabaseInfo(file);

    databaseSegment = this.databaseInfo.segment;
    recordLength = this.databaseInfo.recordLength;
    databaseType = this.databaseInfo.type;
