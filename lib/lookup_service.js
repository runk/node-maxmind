...
module.exports.seekCountryV6 = function(db, ipAddress) {
...
module.exports.getCountryV6 = function(ipAddress) {
  var db = _getDb([
    DatabaseInfo.COUNTRY_EDITION_V6
  ]);

  return lookupCtr(db, this.seekCountryV6(db, ipAddress));
};
