...
exports.getNetSpeed = function(ipv4) {
  return lookupOrg(
    _getDb([DatabaseInfo.NETSPEED_EDITION_REV1]),
    exports.seekCountry(db, ipv4)
  );
};
...
exports.getNetSpeedV6 = function(ipv6) {
  return lookupOrg(
    _getDb([DatabaseInfo.NETSPEED_EDITION_REV1_V6]),
    exports.seekCountry(db, ipv6)
  );
};
...
exports.getIsp = function(ipv4) {
  return lookupOrg(
    _getDb([DatabaseInfo.ISP_EDITION]),
    exports.seekCountry(db, ipv4)
  );
};
...
exports.getIspV6 = function(ipv6) {
  return lookupOrg(
    _getDb([DatabaseInfo.ISP_EDITION_V6]),
    exports.seekCountry(db, ipv6)
  );
};
...
exports.getAsn = function(ipv4) {
  return lookupOrg(
    _getDb([DatabaseInfo.ASNUM_EDITION]),
    exports.seekCountry(db, ipv4)
  );
};
...
exports.getAsnV6 = function(ipv6) {
  return lookupOrg(
    _getDb([DatabaseInfo.ASNUM_EDITION_V6]),
    exports.seekCountry(db, ipv6)
  );
};
